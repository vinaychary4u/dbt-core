...
test_cases = [ 
    ...
    (every_byte[1:-1], b"\xFF" + every_byte[1:-1] + b"\x01"),  # 01 02 ... FE
    (every_byte[1:], b"\xFF" + every_byte[1:-1] + b"\x02\xFF"),  # 01 02 ... FF -> FF 01 02 ... FE 02 FF
    (every_byte[:-1], b"\x01\xFF" + every_byte[1:-1] + b"\x01"),  # 00 01 02 ... FE -> 01 FF 01 02 .. FE
    (every_byte, b"\x01\xFF" + every_byte[1:-1] + b"\x02\xFF")  # 00 01 02 ... FF -> 01 FF 01 02 ... FE 02 FF
]
