...
from dbt.utils import ExitCodes, args_to_dict, dict_to_str_dict
...
def run_from_args(parsed):
    ...
    fire_event(MainReportArgs(args=dict_to_str_dict(args_to_dict(parsed))))
...
def parse_args(args, cls=DBTArgumentParser):
    ...
    p.add_argument(
        "--log-format",
        choices=["text", "json", "protobuf", "default"],
        default=None,
